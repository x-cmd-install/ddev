...
[![x-cmd/install — ddev Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/ddev.svg?lang=zh)](https://x-cmd.com/install/ddev)
...
合计: **948,890** 行代码（覆盖前 5 种语言、共 **4680** 个文件）。
...
- **上游仓库**: <https://github.com/ddev/ddev>
- **官网**: <https://ddev.com>
- **许可证**: Apache-2.0
...
- **Star**: 3,896 · **Fork**: 720 · **开放 issue**: 3,610 · **贡献者**: 393

## 累计统计

- **发布数**: 224 · **已合并 PR**: 4500 · **开放 PR**: 13 · **已关闭 issue**: 3446 · **开放 issue**: 164 · **提交数**: 4761

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 1 | 53 | 11 | 15 | 21 | 58 |
| last60d | 2026-07-28 | 1 | 139 | 12 | 33 | 40 | 153 |
| 90d | 2026-06-28 | 2 | 193 | 12 | 55 | 50 | 198 |
| last180d | 2026-03-30 | 3 | 357 | 13 | 117 | 68 | 375 |
| 360d | 2025-10-01 | 7 | 682 | 13 | 289 | 98 | 687 |
| last720d | 2024-10-06 | 17 | 1264 | 13 | 656 | 122 | 1276 |
...
ddev 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `ddev` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/ddev.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T04:46:51Z._
